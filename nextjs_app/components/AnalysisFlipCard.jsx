                ...
                >
                    ...
                    >
                        <div className="bg-white rounded-xl shadow-xl border border-gray-200 overflow-hidden">
                            <div className="bg-[#13B38D] px-6 py-4">
                            ...
                            <div className="p-6">
                                <div className="mb-6 p-5 bg-gradient-to-br from-orange-50 to-red-50 rounded-lg border-l-4 border-orange-500">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                                    ...
                                    <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-4 border border-green-200">
                                        <div className="flex items-center gap-2 mb-2">
                                            <TrendingUp className="w-5 h-5 text-[#A7B34F]" />
                                            <span className="text-sm font-semibold text-gray-700">Peak Time</span>
                                        </div>
                                        <p className="text-3xl font-bold text-[#A7B34F]">8:15 AM</p>
                                ...
                                <button
                                    onClick={handleFlip}
                                    className="w-full bg-[#13B38D] text-white py-4 rounded-lg font-semibold text-lg hover:from-[#1f2660] hover:to-[#2d3670] transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
                                >
                        ...
                        <div className="bg-white rounded-xl shadow-xl border border-gray-200 overflow-hidden">
                            ...
                            <div className="p-6 max-h-[600px] overflow-y-auto">
                                <div className="mb-6">
                                    ...
                                    <div className="mt-3 flex items-center justify-center gap-4 text-sm">
                                        <div className="flex items-center gap-2">
                                            <div className="w-3 h-3 bg-[#A7B34F] rounded"></div>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <button className="bg-[#0E3147] text-white py-3 rounded-lg font-semibold hover:bg-[#1f2660] transition-colors">
                                        Export Report
                                    </button>
                                    <button className="bg-[#13B38D] text-white py-3 rounded-lg font-semibold hover:bg-[#96a047] transition-colors">
                                        Save Analysis
                                    </button>
                                </div>
                            </div>
