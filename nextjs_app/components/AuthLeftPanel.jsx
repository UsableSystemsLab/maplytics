...
export default function AuthLeftPanel() {
  return (
    <div className="hidden lg:flex lg:w-[40%] border-r border-gray-200 shadow-xl relative overflow-hidden">
      ...
      <div className="absolute left-1/2 top-[62%] -translate-x-1/2 -translate-y-1/2 pointer-events-none">
        <svg width="650" height="650" viewBox="0 0 650 650">
          ...
          <line
            ...
            style={drawLine('0s')}
          />
          <g transform="translate(325, 45)" style={fadePin('0s')}>
            <use href="#pinNavy" />
          </g>
          ...
          <line
            ...
            style={drawLine('2.4s')}
          />
          <g transform="translate(591, 213)" style={fadePin('2.4s')}>
            <use href="#pinPurple" />
          </g>
          ...
          <line
            ...
            style={drawLine('4.8s')}
          />
          <g transform="translate(490, 558)" style={fadePin('4.8s')}>
            <use href="#pinGreen" />
          </g>
          ...
          <line
            ...
            style={drawLine('7.2s')}
          />
          <g transform="translate(160, 558)" style={fadePin('7.2s')}>
            <use href="#pinNavy" />
          </g>
          ...
          <line
            ...
            style={drawLine('9.6s')}
          />
          <g transform="translate(59, 213)" style={fadePin('9.6s')}>
            <use href="#pinPurple" />
          </g>
        </svg>
      </div>
