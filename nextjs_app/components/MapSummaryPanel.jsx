...
export default function MapSummaryPanel({ selectedLayers, visibleLayerIds, isMobile }) {
    const t = useTranslations("mapSummary");
    ...
    return (
        <div className={cn(
            "absolute bottom-6 start-6 z-40 transition-all duration-300 pointer-events-none",
            isMobile ? "hidden" : "bottom-6 start-6"
        )}>
            <div className="bg-white/90 backdrop-blur-md rounded-xl shadow-lg border border-gray-200 p-3 flex flex-col gap-2 pointer-events-auto min-w-[180px]">
                ...
                <div className="space-y-2">
                    <div className="flex items-center justify-between gap-4">
                        <div className="flex items-center gap-1.5 text-gray-500">
                            ...
                            <span className="text-[10px] font-medium uppercase tracking-wider">{t('layers')}</span>
                        </div>
                    ...
                    <div className="flex items-center justify-between gap-4">
                        <div className="flex items-center gap-1.5 text-gray-500">
                            ...
                            <span className="text-[10px] font-medium uppercase tracking-wider">{t('features')}</span>
                        </div>
                ...
                <div className="mt-1 pt-2 border-t border-gray-100 flex items-center justify-between">
                    <span className="text-[9px] text-gray-400 italic">{t('liveAnalysis')}</span>
