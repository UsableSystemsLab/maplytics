...
INSERT INTO public."user" (email, first_name, middle_name, last_name, password, role)
VALUES
('ahmed.alharbi@example.com', 'Ahmed', 'Saad', 'Alharbi', '$2b$12$KIXxLjqGZq7bYZ5qJ9X8.eZqKxG7YvJ3xKxLjqGZq7bYZ5qJ9X8', 'admin'),
('fatimah.alshehri@example.com', 'Fatimah', 'Ali', 'Alshehri', '$2b$12$KIXxLjqGZq7bYZ5qJ9X8.eZqKxG7YvJ3xKxLjqGZq7bYZ5qJ9X9', 'user'),
('khalid.alqahtani@example.com', 'Khalid', 'Mohammed', 'Alqahtani', '$2b$12$KIXxLjqGZq7bYZ5qJ9X8.eZqKxG7YvJ3xKxLjqGZq7bYZ5qJ9X0', 'user'),
('noura.alzahrani@example.com', 'Noura', 'Omar', 'Alzahrani', '$2b$12$KIXxLjqGZq7bYZ5qJ9X8.eZqKxG7YvJ3xKxLjqGZq7bYZ5qJ9X1', 'user'),
('abdullah.almalki@example.com', 'Abdullah', 'Hassan', 'Almalki', '$2b$12$KIXxLjqGZq7bYZ5qJ9X8.eZqKxG7YvJ3xKxLjqGZq7bYZ5qJ9X2', 'user'),
('sara.alfarhan@example.com', 'Sara', 'Faisal', 'Alfarhan', '$2b$12$KIXxLjqGZq7bYZ5qJ9X8.eZqKxG7YvJ3xKxLjqGZq7bYZ5qJ9X20', 'user'),
('mohammed.alsaud@example.com', 'Mohammed', 'Yousef', 'Alsaud', '$2b$12$KIXxLjqGZq7bYZ5qJ9X8.eZqKxG7YvJ3xKxLjqGZq7bYZ5qJ9X21', 'admin');
